# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/plotTools.ipynb.

# %% auto 0
__all__ = ['correlationPlot', 'setFont', 'plotContrasts', 'savePlots', 'saveDabestData']

# %% ../nbs/API/plotTools.ipynb 3
"""
